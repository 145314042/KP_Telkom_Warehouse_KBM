...
<html>
    ...
    <body>
        ...
        <center><h1 style="font-size: 250%;font-family:helvetica;color:#666666;">Peminjaman Telah Ditolak</h1></center>
        
              	<center><a href="<?php echo site_url('welcome/peminjaman') ?>"><button id="">OK</button></a></center>
        <br><br>
                <center><a href="<?php echo site_url('welcome/history_tolak') ?>"><button id="">Lihat Histori KBM ditolak</button></a></center>
